...
import { useAdminSystemVouchers } from '../../hooks/useAdminSystemVouchers';
...
function isExpired(item: AdminSystemVoucher) {
  return new Date(item.endsAt).getTime() < Date.now();
}

export function AdminSystemVoucherListPage() {
  ...
  async function handleToggle(item: AdminSystemVoucher) {
    setActionError(null);
  ...
  async function handleDelete(item: AdminSystemVoucher) {
    if (!item.canDelete) {
        ...
        <div className="col-xl-12">
          <div className="card">
            <div className="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
              <h4 className="card-title mb-0">All System Vouchers</h4>
