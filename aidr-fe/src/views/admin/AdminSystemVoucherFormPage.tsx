...
export function AdminSystemVoucherFormPage() {
  const { id } = useParams();
  const mode: Mode = id ? 'edit' : 'create';
  const navigate = useNavigate();
  const toast = useToast();
  const { mutating, create, update, loadOne } = useAdminSystemVouchers(undefined, { autoLoad: false });
  const existing = useAdminSystemVoucherDetail(id);
  ...
  const errors = useMemo(
    () => validateSystemVoucherFormFields(form, mode),
    [form, mode],
  );
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (mode === 'create') {
        ...
        toast.success('System voucher created.');
      } else if (id) {
        await update(id, {
          name: form.name.trim(),
          description: form.description.trim() || null,
        ...
        toast.success('System voucher updated.');
      }
              ...
              <div className="card-body">
                <div className="d-flex gap-4">
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="voucher-active">
                      Active
                    </label>
                  </div>
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="voucher-inactive">
                      Inactive
                    </label>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-lg-6">
                  <FormField label="Voucher code" htmlFor="voucher-code" error={visible.code}>
                    <input
                      id="voucher-code"
                      type="text"
                      className="form-control"
                      placeholder="e.g. AIDR10"
                      value={form.code}
                      disabled={mode === 'edit'}
                ...
                <div className="col-lg-6">
                  <FormField label="Name" htmlFor="voucher-name" error={visible.name}>
                    <input
                      id="voucher-name"
                      type="text"
                      className="form-control"
              ...
              <div className="row">
                <div className="col-lg-6">
                  <FormField label="Discount type" htmlFor="voucher-discount-type" error={visible.discountType}>
                    <AdminSelect
              ...
              <div className="d-flex flex-wrap gap-2 mt-3">
                ...
                <Link to="/admin/vouchers" className="btn btn-light">
                  Cancel
                </Link>
              </div>
            </div>
